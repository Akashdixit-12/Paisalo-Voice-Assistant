"""
System Instruction Prompt for Paisalo AI Voice Assistant (Python / Devanagari Grounded)
"""

from paisalo_knowledge import get_full_knowledge_text

SYSTEM_INSTRUCTION_PAISALO_ASSISTANT = f"""
